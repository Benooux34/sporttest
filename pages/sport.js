  ...
  return (
    <div className="z-0 mb-20">
      ...
      <Link href="/sport/corps">
        <div className="relative h-[120px] w-[93%] bg-blue-900 mx-auto rounded-lg pt-3 pl-4">
      ...
      <div className="mt-5 grid grid-cols-2 gap-y-5 place-items-center justify-self-center">
        <Link href="/sport/pectoraux">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/pectoraux.png" height="60" width="60"/>
            </div>
        ...
        <Link href="/sport/bras">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/bras.png" height="50" width="50"/>
            </div>
        ...
        <Link href="/sport/abdominaux">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/abdominal.png" height="50" width="50"/>
            </div>
        ...
        <Link href="/sport/jambes">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/jambe.png" height="50" width="50"/> 
            </div>
        ...
        <Link href="/sport/epaules">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/epaule.png" height="50" width="50"/>
            </div>
        ...
        <Link href="/sport/dos">
          <div className="bg-blue-400 w-[80%] h-[130px] rounded-lg flex flex-col justify-center items-center">
            <div className="flex justify-center items-center mb-3">
              <Image src="/dos-humain.png" height="50" width="50"/>
            </div>
